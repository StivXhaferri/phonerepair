    ...
    return(
        <div className='bg-[#191A23] w-[80%] sm:w-full mx-auto p-3 mt-[5%]' style={{borderRadius: '25px 25px 0px 0px'}}>
            <div className='flex items-center w-full sm:flex-col'>
                ...
                <div className='w-[40%] flex gap-3 py-3 sm:w-full flex-col sm:text-center'>
                    <a href="" className='text-[white] text-sm'>Services</a>
                    <a href="" className='text-[white] text-sm'>Why Choose US</a>
                    <a href="" className='text-[white] text-sm'>About US</a>
                    <a href="" className='text-[white] text-sm' >Devices</a>
                    <a href="" className='text-[white] text-sm' >FAQ</a>
                    <a href="" className='text-[white] text-sm' >Contact US</a>
                </div>
            ...
            <div className='flex w-full px-12 sm:flex-col'>
                <div className='w-[40%] flex-col flex-grow gap-2 sm:w-full sm:text-center' >
                    ...
                    <h2 className='text-white py-3'>Phone:02321231231231</h2>
